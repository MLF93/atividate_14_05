...
public class EditarSleep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editar_sleep);
        ...
        buttonConfirmar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(EditarSleep.this, FuncoesSleep.class);
    ...
    private void atualizarDadosWarning(String quantity, String time) {
        ...
        warningDocRef
                ...
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(EditarSleep.this, "Dados atualizados com sucesso", Toast.LENGTH_SHORT).show();
                    finish();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(EditarSleep.this, "Erro ao atualizar os dados", Toast.LENGTH_SHORT).show();
                });
    }
}