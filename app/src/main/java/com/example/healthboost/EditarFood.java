...
public class EditarFood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonConfirmar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(EditarFood.this, FuncoesFood.class);
    ...
    private void atualizarDadosWarning(String quantity, String time) {
        ...
        warningDocRef
                ...
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(EditarFood.this, "Dados atualizados com sucesso", Toast.LENGTH_SHORT).show();
                    finish();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(EditarFood.this, "Erro ao atualizar os dados", Toast.LENGTH_SHORT).show();
                });
    }
}