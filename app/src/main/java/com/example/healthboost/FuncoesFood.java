...
public class FuncoesFood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_funcoes_food);
        ...
        pesquisarDadosWarning("food");

        ImageView editImageView = findViewById(R.id.editquant_btn);
        editImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FuncoesFood.this, EditarFood.class);
