...
public class EditarMeds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editar_meds);
        ...
        buttonConfirmar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(EditarMeds.this, FuncoesMeds.class);
    ...
    private void atualizarDadosWarning(String quantity, String time) {
        ...
        warningDocRef
                ...
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(EditarMeds.this, "Dados atualizados com sucesso", Toast.LENGTH_SHORT).show();
                    finish();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(EditarMeds.this, "Erro ao atualizar os dados", Toast.LENGTH_SHORT).show();
                });
    }
}