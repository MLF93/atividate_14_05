...
public class EditarWater extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editar_water);
        ...
        buttonConfirmar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(EditarWater.this, FuncoesWater.class);
    ...
    private void atualizarDadosWarning(String quantity, String time) {
        ...
        warningDocRef
                ...
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(EditarWater.this, "Dados atualizados com sucesso", Toast.LENGTH_SHORT).show();
                    finish();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(EditarWater.this, "Erro ao atualizar os dados", Toast.LENGTH_SHORT).show();
                });
    }
}