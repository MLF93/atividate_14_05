...
public class FuncoesSleep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_funcoes_sleep);
        ...
        pesquisarDadosWarning("sleep");

        ImageView editImageView = findViewById(R.id.editquant_btn);
        editImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FuncoesSleep.this, EditarSleep.class);
