...
public class FuncoesWater extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_funcoes_water);
        ...
        pesquisarDadosWarning("water");

        ImageView editImageView = findViewById(R.id.editquant_btn);
        editImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FuncoesWater.this, EditarWater.class);
